...
def reformat_stories():
    ...
    with open('nyt/nyt_tweet_img.txt', 'r') as txt:
        listified = []
        for line in txt.readlines():
            for lil_line in textwrap.wrap(line, 80):
                listified.append(lil_line)
    with open('nyt/nyt_tweet_img.txt', 'w') as img_txt:
...
def write_text_to_image():
    ...
    img_resized.save('nyt/nyt_tweet.png')
